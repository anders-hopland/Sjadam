...
public class Queen extends AbstractPiece {
    ...
    public Queen(PLAYER_COLOR color) {
        ...
        if (color == PLAYER_COLOR.BLACK) {
            ...
            TextureRegion region = new TextureRegion(texture, 512, 0, 128, 128);
            sprite = new Sprite(region);
        }
        else  {
            texture = new Texture(Gdx.files.internal("chess.png"));
            TextureRegion region = new TextureRegion(texture, 512, 128, 128, 128);
            sprite = new Sprite(region);
        }
