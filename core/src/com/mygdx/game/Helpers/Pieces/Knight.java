...
public class Knight extends AbstractPiece {
    ...
    public Knight(PLAYER_COLOR color) {
        ...
        if (color == PLAYER_COLOR.BLACK) {
            ...
            TextureRegion region = new TextureRegion(texture, 128, 0, 128, 128);
            sprite = new Sprite(region);
        }
        else  {
            texture = new Texture(Gdx.files.internal("chess.png"));
            TextureRegion region = new TextureRegion(texture, 128, 128, 128, 128);
            sprite = new Sprite(region);
        }
