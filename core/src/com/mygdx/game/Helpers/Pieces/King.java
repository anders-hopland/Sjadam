...
public class King extends AbstractPiece {
    ...
    public King(PLAYER_COLOR color) {
        ...
        if (color == PLAYER_COLOR.BLACK) {
            ...
            TextureRegion region = new TextureRegion(texture, 640, 0, 128, 128);
            sprite = new Sprite(region);
        }
        else  {
            texture = new Texture(Gdx.files.internal("chess.png"));
            TextureRegion region = new TextureRegion(texture, 640, 128, 128, 128);
            sprite = new Sprite(region);
        }
