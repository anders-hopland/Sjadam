...
public class Rook extends AbstractPiece {
    ...
    public Rook(PLAYER_COLOR color) {
        Sprite sprite;
        Texture texture;
        ...
        if (color == PLAYER_COLOR.BLACK) {
            ...
            TextureRegion region = new TextureRegion(texture, 384, 0, 128, 128);
            sprite = new Sprite(region);
        }
        else  {
            texture = new Texture(Gdx.files.internal("chess.png"));
            TextureRegion region = new TextureRegion(texture, 384, 128, 128, 128);
            sprite = new Sprite(region);
        }
